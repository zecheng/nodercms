...
module.exports = {
    ...
    //获取阿里云SDK
    getAlySdk:function(callback){ console.log(ALYMobile.bucket);
        var sts = new ALY.STS({
        ...
        sts.assumeRole({
            Action: 'AssumeRole',
            RoleArn: 'acs:ram::1401678574034074:role/video-oss-upload',
            Policy: '{"Version":"1","Statement":[{"Effect":"Allow", "Action":["oss:PutObject"], "Resource":"*"}]}',
            DurationSeconds: 3600,
            RoleSessionName: 'SinaVR'
        }, function (err, res) {
            var credentials ={
                    ...
                    'region':           ALYMobile.region,
                    'bucket':           ALYMobile.bucket
                };
